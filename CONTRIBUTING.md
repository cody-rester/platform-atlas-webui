# Contributing to platform-atlas-webui

Thank you for your interest in contributing to the platform-atlas-webui project! This document provides guidelines and instructions for contributing to this project.
...
1. **Fork and clone the repository:**
   ```bash
   git clone https://github.com/YOUR-USERNAME/platform-atlas-webui.git
   cd platform-atlas-webui
   ```

2. **Add the upstream remote:**
   ```bash
   git remote add upstream https://github.com/itential/platform-atlas-webui.git
   ```
...
Thank you for contributing to platform-atlas-webui!
