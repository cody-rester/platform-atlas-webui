...
[![Build Status](https://github.com/itential/platform-atlas-webui/actions/workflows/ci.yml/badge.svg)](https://github.com/itential/platform-atlas-webui/actions/workflows/ci.yml)
[![License](https://img.shields.io/badge/License-GPL--3.0-blue.svg)](LICENSE)
[![GitHub release](https://img.shields.io/github/v/release/itential/platform-atlas-webui)](https://github.com/itential/platform-atlas-webui/releases)
-->
...
A brief description of what platform-atlas-webui does and why it exists.
...
# npm install -g platform-atlas-webui
# brew install itential/tap/platform-atlas-webui
# go install github.com/itential/platform-atlas-webui@latest
```

### From Source

```bash
git clone https://github.com/itential/platform-atlas-webui.git
cd platform-atlas-webui

# Add build/install commands for your tech stack
# Examples:
# pip install -e .
# npm install && npm run build
# go build -o platform-atlas-webui .
# cargo build --release
```
...
```bash
# Configure a device
platform-atlas-webui configure --target router1.example.com --config network.yaml
...
- **Bug Reports**: [Open an issue](https://github.com/itential/platform-atlas-webui/issues/new)
- **Questions**: [Start a discussion](https://github.com/itential/platform-atlas-webui/discussions)
